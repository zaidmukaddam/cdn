...
export default function Home() {
  ...
  async function fileUpload(file: Blob, name: string) {
    try {
      ...
      let {data: data, error: uploadError } = await supabase.storage
        ...
        toast(
          <span>
            ...
            <button
              ...
              onClick={() =>
                clipboard.copy(`https://localhost:4200/api/${redirect}`)
              }
            >
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>cdn - zaidmukaddam.biz</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <a
        href="https://github.com/zaidmukaddam/cdn"
      ...
      >
        <a
          href="https://vercel.com?utm_source=cdn.zaidmukaddam.biz&utm_medium=default-template&utm_campaign=zaidmukaddam.biz"
          target="_blank"
        >
          Powered by{" "}
